<script lang="ts">
    ...
    import { IconBarsBottomRight, IconList } from "$lib/components/icons"
...
>
    ...
    <article
        class="article-content mx-auto max-w-prose pt-(--main-pt) pb-(--main-pb) xl:min-h-(--svh-no-header) xl:w-full xl:max-w-auto"
    >
        {#if data.frontmatter.title}
